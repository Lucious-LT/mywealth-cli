...
export default function InsureLayout({ children }: { children: any }) {
  ...
  const recentTab = () => {
    if (router.pathname === "/insure") return "overview";
    else if (router.pathname === "/insure/quotes") return "quotes";
    else if (router.pathname === "/insure/policy") return "policy";
    else if (router.pathname === "/insure/claims") return "claims";
    // else if (router.pathname === "/insure/stats") return "stats";
  };
