...
/**
 * A JSON blob representing a money market transaction. The fields marked with an * means that they are required.
 */
export type MoneyMarketTransaction = {
     ...
     */
    status?: MoneyMarketTransaction.status;
    /**
    ...
    orderDesc: string;
    /**
     * The discount rate used to book the transaction.
     */
    discountRate: number;
    /**
     ...
     */
    interestType: MoneyMarketTransaction.interestType;
    /**
     ...
     */
    interestBasis: MoneyMarketTransaction.interestBasis;
    /**
     * The channel through which the transaction was submitted
     */
    channel: MoneyMarketTransaction.channel;
    /**
...
export namespace MoneyMarketTransaction {
