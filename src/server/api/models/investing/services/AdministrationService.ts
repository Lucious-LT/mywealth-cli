...
export class AdministrationService {
     ...
     * This is a maintenance transaction that will snapshot the requested record type, emitting the records to the data-message kafka topic. **Requires a valid token**. Roles Allowed: {tenant_view}
     * @param recordType
     ...
     * This is a maintenance transaction that should be used to update the search index for a given record type. This should only be used if the search index is out of sync with the database. **Requires a valid token**. Roles Allowed: {tenant_view}
     * @param recordType
     * @param xTenantId The tenant identifier
     * @returns TransactionResponse OK
     * @throws ApiError
