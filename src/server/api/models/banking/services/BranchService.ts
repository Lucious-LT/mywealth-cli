...
export class BranchService {
    ...
    public findBranchByCode(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/banking/api/v1/branches/code/{code}',
            path: {
                'code': code,
            },
            headers: {
    ...
    public isBranchCodeAvailable(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/banking/api/v1/branches/is-available/code',
            headers: {
                'x-tenant-id': xTenantId,
            },
            query: {
    ...
    public listBranch(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/banking/api/v1/branches/list',
            headers: {
                'x-tenant-id': xTenantId,
            },
            query: {
    ...
    public searchBranch(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/banking/api/v1/branches/search',
            headers: {
                'x-tenant-id': xTenantId,
            },
            query: {
    ...
    public findBranchById(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/banking/api/v1/branches/{id}',
            path: {
                'id': id,
            },
            headers: {
