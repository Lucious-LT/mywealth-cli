...
import type { LedgerListSort } from '../models/LedgerListSort';
...
export class JournalService {
    ...
    public approveJournalById(
        ...
        return this.httpRequest.request({
            method: 'PATCH',
            url: '/accounting/api/v1/journals/approve/{id}',
            path: {
                'id': id,
            },
            headers: {
    ...
    /**
     * Update all the GL balances for a date range
     * Update all the GL balances for a date range
     * @param endDate
     * @param startDate
     * @param xTenantId The tenant identifier
    ...
    public updateGlBalances(
        ...
        return this.httpRequest.request({
            method: 'PATCH',
            url: '/accounting/api/v1/journals/balance',
            headers: {
                'x-tenant-id': xTenantId,
            },
            query: {
    ...
    public findJournalByCode(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/accounting/api/v1/journals/code/{code}',
            path: {
                'code': code,
            },
            headers: {
    ...
    public listJournal(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/accounting/api/v1/journals/list',
            headers: {
                'x-tenant-id': xTenantId,
            },
            query: {
     ...
     * Retrieve ledger entries in the system using the supported query parameters.
     * @param accountId
     * @param order
     * @param sort
     * @param xTenantId The tenant identifier
     ...
     * @throws ApiError
     */
    public listGlAccountLedgerEntries(
        accountId: UUID,
        order: Direction,
        sort: LedgerListSort,
        xTenantId: string,
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/accounting/api/v1/journals/list/ledger/gl-account/{accountId}',
            path: {
                'accountId': accountId,
            },
            headers: {
    ...
    /**
     * List ledger entries for a sub account
     * Retrieve ledger entries for a sub account in the system using the supported query parameters.
     * @param subAccountId
     * @param order
     * @param sort
     * @param xTenantId The tenant identifier
     ...
     * @throws ApiError
     */
    public listSubAccountLedgerEntries(
        subAccountId: UUID,
        order: Direction,
        sort: LedgerListSort,
        xTenantId: string,
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/accounting/api/v1/journals/list/ledger/sub-account/{subAccountId}',
            path: {
     ...
     * Retrieve manual journals in the system using the supported query parameters.
     * @param order
     * @param sort
     * @param xTenantId The tenant identifier
     * @param page
    ...
    public listManualJournal(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/accounting/api/v1/journals/list/manual',
            headers: {
                'x-tenant-id': xTenantId,
            },
            query: {
    ...
    public addJournal(
        ...
        return this.httpRequest.request({
            method: 'POST',
            url: '/accounting/api/v1/journals/manual',
            headers: {
                'x-tenant-id': xTenantId,
            },
            body: requestBody,
    ...
    public postJournalById(
        ...
        return this.httpRequest.request({
            method: 'PATCH',
            url: '/accounting/api/v1/journals/post/{id}',
            path: {
                'id': id,
            },
            headers: {
    ...
    /**
     * Reverse a posted system journal
     * Reverse a posted system journal using the journal ID.
     * @param id
     * @param xTenantId The tenant identifier
     * @returns JournalResponse Indicates that the request was successful.
     * @throws ApiError
     */
    public reverseSystemJournalById(
        id: UUID,
        xTenantId: string,
    ): CancelablePromise<JournalResponse> {
        return this.httpRequest.request({
            method: 'PATCH',
            url: '/accounting/api/v1/journals/reverse/system/{id}',
            path: {
                'id': id,
            },
            headers: {
    ...
    public reverseJournalById(
        ...
        return this.httpRequest.request({
            method: 'PATCH',
            url: '/accounting/api/v1/journals/reverse/{id}',
            path: {
                'id': id,
            },
            headers: {
    ...
    public searchJournal(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/accounting/api/v1/journals/search',
            headers: {
                'x-tenant-id': xTenantId,
            },
            query: {
    ...
    /**
     * Create a new journal and post it. Only system journals can use this API.
     * Creates and posts a new journal. See the schema of the object for more information.
     * @param xTenantId The tenant identifier
     * @param requestBody
    ...
    public addAndPostJournal(
        ...
        return this.httpRequest.request({
            method: 'POST',
            url: '/accounting/api/v1/journals/system',
            headers: {
                'x-tenant-id': xTenantId,
     ...
     * Creates or update journals in the system using an excel file. If any of the records in the file is invalid, or any journal is not balanced for a given value date, the whole transaction will be rolled back.See the documentation for the expected file format for more information.
     * @param xTenantId The tenant identifier
     * @param formData
     * @param transDate
     * @param valueDate
    ...
    public uploadJournals(
        ...
        return this.httpRequest.request({
            method: 'POST',
            url: '/accounting/api/v1/journals/upload',
            headers: {
                'x-tenant-id': xTenantId,
            },
            query: {
    ...
    public findJournalById(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/accounting/api/v1/journals/{id}',
            path: {
                'id': id,
            },
            headers: {
