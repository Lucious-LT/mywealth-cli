...
export class DynamicAssetValueDividendService {
    ...
    public addDynamicAssetValueDividend(
        ...
        return this.httpRequest.request({
            method: 'POST',
            url: '/funds/api/v1/transaction/dyn-asset-value/dividend',
            headers: {
    ...
    public approveDynamicAssetValueDividendById(
        ...
        return this.httpRequest.request({
            method: 'PATCH',
            url: '/funds/api/v1/transaction/dyn-asset-value/dividend/approve/{id}',
            path: {
                'id': id,
            },
            headers: {
    ...
    public findDynamicAssetValueDividendByCode(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/funds/api/v1/transaction/dyn-asset-value/dividend/code/{code}',
            path: {
                'code': code,
            },
            headers: {
    ...
    public listDynamicAssetValueDividend(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/funds/api/v1/transaction/dyn-asset-value/dividend/list',
            headers: {
                'x-tenant-id': xTenantId,
            },
            query: {
    ...
    public postDynamicAssetValueDividendById(
        ...
        return this.httpRequest.request({
            method: 'PATCH',
            url: '/funds/api/v1/transaction/dyn-asset-value/dividend/post/{id}',
            path: {
                'id': id,
            },
            headers: {
    ...
    public reverseDynamicAssetValueDividendById(
        ...
        return this.httpRequest.request({
            method: 'PATCH',
            url: '/funds/api/v1/transaction/dyn-asset-value/dividend/reverse/{id}',
            path: {
                'id': id,
            },
            headers: {
    ...
    public searchDynamicAssetValueDividend(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/funds/api/v1/transaction/dyn-asset-value/dividend/search',
            headers: {
                'x-tenant-id': xTenantId,
            },
            query: {
    ...
    public uploadDynamicAssetValueDividends(
        ...
        return this.httpRequest.request({
            method: 'POST',
            url: '/funds/api/v1/transaction/dyn-asset-value/dividend/upload',
            headers: {
                'x-tenant-id': xTenantId,
            },
            query: {
    ...
    public findDynamicAssetValueDividendById(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/funds/api/v1/transaction/dyn-asset-value/dividend/{id}',
            path: {
                'id': id,
            },
            headers: {
