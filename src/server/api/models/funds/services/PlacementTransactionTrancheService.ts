...
export class PlacementTransactionTrancheService {
    ...
    public addPlacementTransactionTranche(
        ...
        return this.httpRequest.request({
            method: 'POST',
            url: '/funds/api/v1/transaction/placement/tranche',
            headers: {
    ...
    public approvePlacementTransactionTrancheById(
        ...
        return this.httpRequest.request({
            method: 'PATCH',
            url: '/funds/api/v1/transaction/placement/tranche/approve/{transactionId}/{trancheId}',
            path: {
                'trancheId': trancheId,
    ...
    public postPlacementTransactionTrancheById(
        ...
        return this.httpRequest.request({
            method: 'PATCH',
            url: '/funds/api/v1/transaction/placement/tranche/post/{transactionId}/{trancheId}',
            path: {
                'trancheId': trancheId,
                'transactionId': transactionId,
            },
    ...
    public reversePlacementTransactionTrancheById(
        ...
        return this.httpRequest.request({
            method: 'PATCH',
            url: '/funds/api/v1/transaction/placement/tranche/reverse/{transactionId}/{trancheId}',
            path: {
                'trancheId': trancheId,
                'transactionId': transactionId,
            },
    ...
    public updatePlacementTransactionTranche(
        ...
        return this.httpRequest.request({
            method: 'PUT',
            url: '/funds/api/v1/transaction/placement/tranche/{transactionId}/{trancheId}',
            path: {
                'trancheId': trancheId,
                'transactionId': transactionId,
            },
