...
/**
 * Describes a contact in the system. The fields marked with an * means that they are required.
 */
export type Contact = {
    /**
    ...
    /**
     * The last IP address used to login
     */
    lastLoginIPAddress?: string;
    /**
     * The # of failed login attempts. This is reset after a successful login
     */
    failedLoginAttempts?: number;
    /**
     * The last time the contact logged in
     */
    ...
    idNo?: string;
    /**
     * The financial ID number for the contact
     */
    finIdNo?: string;
    /**
     ...
     */
    networthTotalRange?: Contact.networthTotalRange;
    /**
     * The contact's annual income range
     */
    annualIncomeRange?: Contact.annualIncomeRange;
    /**
     * The contact's liquid net worth range
     */
    networthLiquidRange?: Contact.networthLiquidRange;
    /**
     * The contact's source of wealth
     */
    sourceOfWealth?: Contact.sourceOfWealth;
    /**
     * The contact's investment knowledge or sophistication
     */
    investmentExperience?: Contact.investmentExperience;
    /**
     ...
     * The contact's risk tolerance
     */
    investmentObj?: Contact.investmentObj;
    /**
