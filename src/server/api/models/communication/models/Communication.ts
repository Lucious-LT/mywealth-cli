...
export type Communication = {
    ...
    mimeType?: string;
    /**
     * A timestamp indicating when the request was received by the service
     */
    startTime?: string;
    /**
     * A timestamp indicating when the request was completed by the service
     */
    endTime?: string;
    /**
     * The ticket id from a delivery service
     */
    ticketId?: string;
    /**
