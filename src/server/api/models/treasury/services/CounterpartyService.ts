...
export class CounterpartyService {
    ...
    public addCounterparty(
        ...
        return this.httpRequest.request({
            method: 'POST',
            url: '/treasury/api/v1/counterparties',
            headers: {
    ...
    public findCounterpartyByCode(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/treasury/api/v1/counterparties/code/{code}',
            path: {
                'code': code,
            },
            headers: {
    ...
    public isCounterpartyCodeAvailable(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/treasury/api/v1/counterparties/is-available/code',
            headers: {
                'x-tenant-id': xTenantId,
            },
            query: {
    ...
    public listCounterparty(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/treasury/api/v1/counterparties/list',
            headers: {
                'x-tenant-id': xTenantId,
            },
            query: {
    ...
    public searchCounterparty(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/treasury/api/v1/counterparties/search',
            headers: {
                'x-tenant-id': xTenantId,
            },
            query: {
    ...
    public findCounterpartyById(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/treasury/api/v1/counterparties/{id}',
            path: {
                'id': id,
            },
            headers: {
