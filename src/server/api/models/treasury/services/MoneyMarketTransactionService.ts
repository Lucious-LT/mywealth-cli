...
export class MoneyMarketTransactionService {
    ...
    public addMoneyMarketTransaction(
        ...
        return this.httpRequest.request({
            method: 'POST',
            url: '/treasury/api/v1/transaction/money_market',
            headers: {
    ...
    public approveMoneyMarketTransactionById(
        ...
        return this.httpRequest.request({
            method: 'PATCH',
            url: '/treasury/api/v1/transaction/money_market/approve/{id}',
            path: {
                'id': id,
            },
            headers: {
    ...
    public findMoneyMarketTransactionByCode(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/treasury/api/v1/transaction/money_market/code/{code}',
            path: {
                'code': code,
            },
            headers: {
    ...
    public listMoneyMarketTransaction(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/treasury/api/v1/transaction/money_market/list',
            headers: {
                'x-tenant-id': xTenantId,
            },
            query: {
    ...
    public postMoneyMarketTransactionById(
        ...
        return this.httpRequest.request({
            method: 'PATCH',
            url: '/treasury/api/v1/transaction/money_market/post/{id}',
            path: {
                'id': id,
            },
            headers: {
    ...
    public reverseMoneyMarketTransactionById(
        ...
        return this.httpRequest.request({
            method: 'PATCH',
            url: '/treasury/api/v1/transaction/money_market/reverse/{id}',
            path: {
                'id': id,
            },
            headers: {
    ...
    public searchMoneyMarketTransaction(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/treasury/api/v1/transaction/money_market/search',
            headers: {
                'x-tenant-id': xTenantId,
            },
            query: {
    ...
    public terminateMoneyMarketTransaction(
        ...
        return this.httpRequest.request({
            method: 'POST',
            url: '/treasury/api/v1/transaction/money_market/terminate',
            headers: {
                'x-tenant-id': xTenantId,
            },
            body: requestBody,
    ...
    public uploadMoneyMarketTransactions(
        ...
        return this.httpRequest.request({
            method: 'POST',
            url: '/treasury/api/v1/transaction/money_market/upload',
            headers: {
                'x-tenant-id': xTenantId,
            },
            formData: formData,
    ...
    public findMoneyMarketTransactionById(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/treasury/api/v1/transaction/money_market/{id}',
            path: {
                'id': id,
            },
            headers: {
