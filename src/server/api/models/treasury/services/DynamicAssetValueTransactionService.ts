...
export class DynamicAssetValueTransactionService {
    ...
    public addDynamicAssetValueTransaction(
        ...
        return this.httpRequest.request({
            method: 'POST',
            url: '/treasury/api/v1/transaction/dyn_asset_value',
            headers: {
    ...
    public approveDynamicAssetValueTransactionById(
        ...
        return this.httpRequest.request({
            method: 'PATCH',
            url: '/treasury/api/v1/transaction/dyn_asset_value/approve/{id}',
            path: {
                'id': id,
            },
            headers: {
    ...
    public findDynamicAssetValueTransactionByCode(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/treasury/api/v1/transaction/dyn_asset_value/code/{code}',
            path: {
                'code': code,
            },
            headers: {
    ...
    public listDynamicAssetValueTransaction(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/treasury/api/v1/transaction/dyn_asset_value/list',
            headers: {
                'x-tenant-id': xTenantId,
            },
            query: {
    ...
    public postDynamicAssetValueTransactionById(
        ...
        return this.httpRequest.request({
            method: 'PATCH',
            url: '/treasury/api/v1/transaction/dyn_asset_value/post/{id}',
            path: {
                'id': id,
            },
            headers: {
    ...
    public reverseDynamicAssetValueTransactionById(
        ...
        return this.httpRequest.request({
            method: 'PATCH',
            url: '/treasury/api/v1/transaction/dyn_asset_value/reverse/{id}',
            path: {
                'id': id,
            },
            headers: {
    ...
    public searchDynamicAssetValueTransaction(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/treasury/api/v1/transaction/dyn_asset_value/search',
            headers: {
                'x-tenant-id': xTenantId,
            },
            query: {
    ...
    public sellDynamicAssetValueTransaction(
        ...
        return this.httpRequest.request({
            method: 'POST',
            url: '/treasury/api/v1/transaction/dyn_asset_value/sell',
            headers: {
                'x-tenant-id': xTenantId,
            },
            body: requestBody,
    ...
    public uploadDynamicAssetValueTransactions(
        ...
        return this.httpRequest.request({
            method: 'POST',
            url: '/treasury/api/v1/transaction/dyn_asset_value/upload',
            headers: {
                'x-tenant-id': xTenantId,
            },
            query: {
    ...
    public findDynamicAssetValueTransactionById(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/treasury/api/v1/transaction/dyn_asset_value/{id}',
            path: {
                'id': id,
            },
            headers: {
