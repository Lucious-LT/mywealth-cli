...
export class FixedIncomeTransactionService {
    ...
    public addFixedIncomeTransaction(
        ...
        return this.httpRequest.request({
            method: 'POST',
            url: '/treasury/api/v1/transaction/fixed_income',
            headers: {
    ...
    public approveFixedIncomeTransactionById(
        ...
        return this.httpRequest.request({
            method: 'PATCH',
            url: '/treasury/api/v1/transaction/fixed_income/approve/{id}',
            path: {
                'id': id,
            },
            headers: {
    ...
    public findFixedIncomeTransactionByCode(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/treasury/api/v1/transaction/fixed_income/code/{code}',
            path: {
                'code': code,
            },
            headers: {
    ...
    public listFixedIncomeTransaction(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/treasury/api/v1/transaction/fixed_income/list',
            headers: {
                'x-tenant-id': xTenantId,
            },
            query: {
    ...
    public postFixedIncomeTransactionById(
        ...
        return this.httpRequest.request({
            method: 'PATCH',
            url: '/treasury/api/v1/transaction/fixed_income/post/{id}',
            path: {
                'id': id,
            },
            headers: {
    ...
    public reverseFixedIncomeTransactionById(
        ...
        return this.httpRequest.request({
            method: 'PATCH',
            url: '/treasury/api/v1/transaction/fixed_income/reverse/{id}',
            path: {
                'id': id,
            },
            headers: {
    ...
    public searchFixedIncomeTransaction(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/treasury/api/v1/transaction/fixed_income/search',
            headers: {
                'x-tenant-id': xTenantId,
            },
            query: {
    ...
    public sellFixedIncomeTransaction(
        ...
        return this.httpRequest.request({
            method: 'POST',
            url: '/treasury/api/v1/transaction/fixed_income/sell',
            headers: {
                'x-tenant-id': xTenantId,
            },
            body: requestBody,
    ...
    public uploadFixedIncomeTransactions(
        ...
        return this.httpRequest.request({
            method: 'POST',
            url: '/treasury/api/v1/transaction/fixed_income/upload',
            headers: {
                'x-tenant-id': xTenantId,
            },
            query: {
    ...
    public findFixedIncomeTransactionById(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/treasury/api/v1/transaction/fixed_income/{id}',
            path: {
                'id': id,
            },
            headers: {
