...
export class PlacementTransactionService {
    ...
    public addPlacementTransaction(
        ...
        return this.httpRequest.request({
            method: 'POST',
            url: '/treasury/api/v1/transaction/placement',
            headers: {
    ...
    public approvePlacementTransactionById(
        ...
        return this.httpRequest.request({
            method: 'PATCH',
            url: '/treasury/api/v1/transaction/placement/approve/{id}',
            path: {
                'id': id,
            },
            headers: {
    ...
    public findPlacementTransactionByCode(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/treasury/api/v1/transaction/placement/code/{code}',
            path: {
                'code': code,
            },
            headers: {
    ...
    public listPlacementTransaction(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/treasury/api/v1/transaction/placement/list',
            headers: {
                'x-tenant-id': xTenantId,
            },
            query: {
    ...
    public postPlacementTransactionById(
        ...
        return this.httpRequest.request({
            method: 'PATCH',
            url: '/treasury/api/v1/transaction/placement/post/{id}',
            path: {
                'id': id,
            },
            headers: {
    ...
    public terminatePlacementTransactionById(
        ...
        return this.httpRequest.request({
            method: 'PATCH',
            url: '/treasury/api/v1/transaction/placement/post/{transactionId}/{terminationDate}',
            path: {
    ...
    public reversePlacementTransactionById(
        ...
        return this.httpRequest.request({
            method: 'PATCH',
            url: '/treasury/api/v1/transaction/placement/reverse/{id}',
            path: {
                'id': id,
            },
            headers: {
    ...
    public searchPlacementTransaction(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/treasury/api/v1/transaction/placement/search',
            headers: {
                'x-tenant-id': xTenantId,
            },
            query: {
    ...
    public uploadPlacementTransactions(
        ...
        return this.httpRequest.request({
            method: 'POST',
            url: '/treasury/api/v1/transaction/placement/upload',
            headers: {
                'x-tenant-id': xTenantId,
            },
            formData: formData,
    ...
    public findPlacementTransactionById(
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/treasury/api/v1/transaction/placement/{id}',
            path: {
                'id': id,
            },
            headers: {
